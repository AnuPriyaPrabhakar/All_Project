...
import com.ponsun.kyc.adminconfiguration.adminconfigmodule.data.AdminConfigModuleDataValidator;
import com.ponsun.kyc.adminconfiguration.adminconfigmodule.domain.AdminConfigModule;
import com.ponsun.kyc.adminconfiguration.adminconfigmodule.domain.AdminConfigModuleRepository;
import com.ponsun.kyc.adminconfiguration.adminconfigmodule.domain.AdminConfigModuleRepositoryWrapper;
...
public class AdminConfigModuleWritePlatformServiceImpl implements AdminConfigModuleWritePlatformService {
    ...
    public Response createAdminConfigModule(CreateAdminConfigModuleRequest createAdminConfigModuleRequest) {
        try {
            ...
            throw new EQAS_KYC_ApplicationException("Error creating AdminConfigModule: " + e.getMessage());
        }
    }
    @Override
    @Transactional
    ...
    public Response deactive(Integer kycId, Integer euid){
        try{
            AdminConfigModule adminConfigModule = this.adminConfigModuleRepositoryWrapper.findOneWithNotFoundDetection(kycId);
