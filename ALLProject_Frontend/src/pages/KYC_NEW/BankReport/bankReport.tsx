    ...
    return (
        <>
            <Box sx={{ display: 'flex' }}>
                <Header />
                <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
               <Card border='10px' style={{ boxShadow: '1px 1px 1px grey', width: '80%', marginLeft: '10%', marginTop: '6%' }}>
                                        ...
                                        <Col xs={8}>
                                            <Form.Group>
                                                <Row>
                                                    ...
                                                    <Col>
                                                        <Button variant="primary" className="btn-pepReport" style={{ marginTop: '18%' }} onClick={handleSearch}>
                                                            Apply Dates
                                                        </Button>
                                                    </Col>
                                                </Row>
