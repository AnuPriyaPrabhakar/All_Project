...
// import { CreateData, kycForm, GetData, GetDatas, DeclarationFrom } from '../../../data/services/kyc/applicationfrom/applicationfrome-payload';
...
//     return (
//         <Box mt={2}>
//             <Card style={{ padding: '4%', boxShadow: 'rgb(0 0 0 / 28%) 0px 4px 8px', width: '100%' }} sx={{ mt: 1, mb: 10, }}>
//                 <Card style={{
                    ...
                    <Box m={2}>
                        ...
                        <Card style={{ padding: '1%', boxShadow: 'rgb(0 0 0 / 28%) 0px 4px 8px', height: '81%', marginTop: '4%' }}>
                            <Grid container>
                                ...
                                <div>
                                    <h4 style={{ textAlign: 'center' }}>CLIENT FORM</h4>
                                </div> <span style={{ marginLeft: '1%' }}></span>
                                <Grid item xs={12} sm={2}>
                                    <div
                                        className={`arrow ${activeButton === 'Application' ? 'active' : ''}`}
                                        onClick={() => {
