                    ...
                    <Table size="small" stickyHeader aria-label="sticky table" style={{ margin: '0 auto' }}>
                        <TableHead sx={{ backgroundColor: '#cccdd1' }}>
                            <TableRow className="tableHeading">
                                ...
                                <TableCell sx={{ backgroundColor: '#D3D3D3', padding: '4px', width: '100px' }} onClick={() => handleSort('name')}>File List {sortedColumn === 'name' && (sortDirection === 'asc' ? '↑' : '↓')}</TableCell>

                                <TableCell sx={{ backgroundColor: '#D3D3D3', padding: '4px', width: '100px' }} onClick={() => handleSort('name')}>Name {sortedColumn === 'fileList' && (sortDirection === 'asc' ? '↑' : '↓')}</TableCell>
                                <TableCell sx={{ backgroundColor: '#D3D3D3', padding: '4px', width: '100px' }} onClick={() => handleSort('dob')}>Type{sortedColumn === 'typeId' && (sortDirection === 'asc' ? '↑' : '↓')}</TableCell>
                                <TableCell sx={{ backgroundColor: '#D3D3D3', padding: '4px', width: '100px' }} onClick={() => handleSort('pob')}>Nationality {sortedColumn === 'pob' && (sortDirection === 'asc' ? '↑' : '↓')}</TableCell>
                                <TableCell sx={{ backgroundColor: '#D3D3D3', padding: '4px', width: '50px' }} onClick={() => handleSort('pan')}>Citizenship {sortedColumn === 'pan' && (sortDirection === 'asc' ? '↑' : '↓')}</TableCell>
                                <TableCell sx={{ backgroundColor: '#D3D3D3', padding: '4px', width: '30px' }} onClick={() => handleSort('directorsIdentificationNumber')}>Passport {sortedColumn === 'directorsIdentificationNumber' && (sortDirection === 'asc' ? '↑' : '↓')}</TableCell>
                                <TableCell sx={{ backgroundColor: '#D3D3D3', padding: '4px', width: '30px' }} onClick={() => handleSort('directorsIdentificationNumber')}>Address {sortedColumn === 'directorsIdentificationNumber' && (sortDirection === 'asc' ? '↑' : '↓')}</TableCell>
