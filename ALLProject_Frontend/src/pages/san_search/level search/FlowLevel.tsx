...
import { Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Card, IconButton, Dialog, DialogTitle, DialogContent, DialogActions, Button, Select, MenuItem, SelectChangeEvent, Box, FormControl, InputLabel, TextField, Grid, Paper, DialogContentText } from '@mui/material';
...
function LevelFlow() {
  ...
  // const handleTableRowClick = async (criminalId: number, fileType: any) => {
  //   const id = String(criminalId);
  //   setLoading(true); // Start loading state at the beginning
  //   // alert(`criminalId: ${criminalId}, fileType: ${fileType}`); // Corrected alert syntax
                        ...
                        <TableRow key={index} style={{ height: '32px' }}>
                          ...
                          <TableCell style={{ padding: '4px' }}>
                            <a
                              ...
                              onClick={(e) => {
                                e.preventDefault();
                                handleTableRowClick(Number(alert.criminalId), alert.fileType);
                              }}
                              style={{
                                cursor: 'pointer',
                                color: '#1677FF',
