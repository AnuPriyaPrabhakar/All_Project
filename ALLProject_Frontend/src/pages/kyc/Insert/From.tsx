                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                ...
                                <div>
                                    ...
                                    <Typography variant="body1" paragraph align="right">
                                        ...
                                        <TextField name="authorizeName" size='small' value={declarationFrom.authorizeName} autoComplete='off' onChange={(event) => handleInputChanges('application', event as ChangeEvent<HTMLInputElement>)} placeholder="Name" />
                                    </Typography>
                                    <Typography variant="body1" paragraph align="right">
                                        {/* <TextField name="authorizeDesignation" size='small' placeholder="Designation" /> */}
                                        <TextField name="authorizeDesignation" size='small' value={declarationFrom.authorizeDesignation} autoComplete='off' onChange={(event) => handleInputChanges('application', event as ChangeEvent<HTMLInputElement>)} placeholder="Designation" />
                                    </Typography>
                                    <Typography variant="body1" paragraph align="right">
                                        (Name & Designation)
                                    </Typography>
                            ...
                            <Card >
                                ...
                                <Card style={{
                                    ...
                                    <div>
                                        ...
                                        <Typography variant="body1" paragraph align="right">
                                            <TextField name="authorizeName" size='small' autoComplete='off' placeholder="Name" />
                                        </Typography>
                                        <Typography variant="body1" paragraph align="right">
                                            <TextField name="authorizeDesignation" size='small' autoComplete='off' placeholder="Designation" />
                                        </Typography>
                                        <Typography variant="body1" paragraph align="right">
                                            (Name & Designation)
                                        </Typography>
