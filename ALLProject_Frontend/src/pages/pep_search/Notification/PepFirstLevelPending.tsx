...
import {  Box,
  Table,  TableBody,  TableContainer,  TableHead,  TableRow,  TableCell,  Paper,  Typography,  Button,  Card,  DialogTitle,  FormControl,  InputLabel,
  Select,  MenuItem,  TextField,  IconButton,  DialogContent,  SelectChangeEvent,  Dialog,  DialogActions,
} from '@mui/material';
...
const NotificationComponent: React.FC = () => {
  ...
  const [selectedNotificationId, setSelectedNotificationId] = useState<number | null>(null); // Track which notification is clicked
                ...
                {notifications.map((notification, index) => (
                  <React.Fragment key={notification.id}>
                    <TableRow style={{ height: '32px' }}>
                      ...
                      <TableCell style={{ padding: '4px' }}>{notification.matching_score}</TableCell>
