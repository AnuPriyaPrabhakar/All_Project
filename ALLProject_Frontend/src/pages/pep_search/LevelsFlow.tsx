...
const SearchComponent = () => {
    ...
    const handleSearch = async () => {
        const searchDTO = {
            ...
            listID: 0, // Example value, adjust as needed
            partySubTypeID: 0, // Example value, adjust as needed
            countryId: 0, // Example value, adjust as needed
            uid: loginDetails.id
        };
    ...
    const handleReset = () => {
        setFormData({ name: '' }); // Reset the name input
                    ...
                    <Table size="small" stickyHeader aria-label="sticky table" style={{ margin: '0 auto' }}>
                        <TableHead sx={{ backgroundColor: '#cccdd1' }}>
                            <TableRow className="tableHeading">
                                ...
                                <TableCell sx={{ backgroundColor: '#D3D3D3', padding: '4px', width: '100px' }} onClick={() => handleSort('pob')}>Place of Birth {sortedColumn === 'pob' && (sortDirection === 'asc' ? '↑' : '↓')}</TableCell>
