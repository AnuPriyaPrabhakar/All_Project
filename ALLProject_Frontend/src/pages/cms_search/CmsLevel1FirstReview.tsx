...
function SearchCms() {
    ...
    const handleReset = () => {
        setFormData({
            cmsId: 0, cmsName: '', cmsRecordType: '', recordTypeId: 0, score: 0, criminalId: '',
            searchId: '',
            hitId: ''
        });
        setFilteredData([]);
        ...
        <>
            <Box sx={{
                ...
                <Box component="main" sx={{
                    flexGrow: 1, p: 3, m: 4, fontFamily: "Bookman Old Style",
                    fontSize: "12px"
                }}>
                        ...
                        <div className="card-body" >
                            ...
                            <Card style={{ padding: '1%', boxShadow: 'rgb(0 0 0 / 28%) 0px 4px 8px', width: '100%' }}>
                                <div style={{
                                    ...
                                    <Slider
                                        style={{ width: '40%',fontFamily: "Bookman Old Style",
                                            fontSize: "12px" }}
                                        value={sliderValue}
                                    ...
                                    <TextField
                                        style={{ width: '20%',fontFamily: "Bookman Old Style",
                                            fontSize: "12px" }}
                                        id="max-score"
                                        size='small'
                                        variant="outlined"
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'center', gap: '3%' }} >
                                        ...
                                        <Button variant="contained"style={{fontFamily: "Bookman Old Style",
              fontSize: "12px"}}  onClick={handleReset}>Reset</Button>
                                    </div>
                                </div>
                            </Card>
                            <br></br>
                            ...
                            <Card style={{ padding: '1%', boxShadow: 'rgb(0 0 0 / 28%) 0px 4px 8px', width: '100%' }}>
                                <Grid item xs={12}>
                                    <div ref={Ref}>
                                        <TableContainer style={{ maxHeight: '400px', overflow: 'auto' ,fontFamily: "Bookman Old Style",
              fontSize: "12px"}}>
              ...
              fontSize: "12px" }}>
                                                <TableHead>
                                                    <TableRow>
                                                        <TableCell
                                                            style={{ position: 'sticky', top: 0, backgroundColor: 'white',fontFamily: "Bookman Old Style",
                                                                fontSize: "12px" }}
                                                        ...
                                                        <TableCell style={{ position: 'sticky', top: 0, backgroundColor: 'white', zIndex: 1 ,fontFamily: "Bookman Old Style",
              fontSize: "12px"}}>
                                                            Action
                                                        </TableCell>
                                                    </TableRow>
                                                        ...
                                                        filteredData.map((row, index) => {
                                                            ...
                                                            return (
                                                                <TableRow key={row.cmsId}>
                                                                    ...
                                                                    <TableCell>{getCountryNameById(row.recordTypeId)}</TableCell>
