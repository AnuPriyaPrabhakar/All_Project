...
class HttpClientWrapper {
  ...
  public getbulk = async (path: string): Promise<any> => {
    ...
    try {
      ...
      // Assuming data is directly inside response.data, adjust if necessary
      return response.data;
    } catch (err: any) {
      // Log the error
  ...
  public kycgets = async (path: string) => {
    ...
    try {
      ...
      console.log("HttpClientWrapper get() response data:", response.data); // Log response.data directly
      console.log("HttpClientWrapper get() end path = " + path);
      return response.data; // Return response.data
    } catch (err: any) {
      console.error("HttpClientWrapper get() error:", err); // Use console.error for errors
      throw err;
    }
  };
